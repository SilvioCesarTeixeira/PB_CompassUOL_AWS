...
videoaulas da trilha de aprendizagem *D&A - AWS - re:Stack* do **Programa de Bolsas CompassUOL AWS**, disponível na UDEMY Business. Ele está dividido em um conteúdo de *Cultura Ágil e Segurança*, dez *Sprints* e um *Desafio*, que podem ser acessadas nos links da seções abaixo.
